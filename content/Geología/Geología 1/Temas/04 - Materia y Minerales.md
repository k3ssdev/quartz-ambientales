---
title: "04 - Materia y Minerales"
aliases: ["Minerales", "Rocas", "Estructura Atómica", "Clasificación de Minerales"]
draft: false
weight: 4
tags:
  - temas
...
Toda la materia está compuesta por **[[Átomos]]**, que son las unidades fundamentales que se combinan para formar los minerales y las rocas.

### Estructura Atómica y Elementos
* **Núcleo**: Compuesto por **[[Protones]]** (carga +1) y **[[Neutrones]]** (sin carga).
* **Electrones**: Partículas con carga -1 que orbitan el núcleo en **[[Capas principales]]**.
* **[[Número Atómico]]**: Definido por el número de protones y determina la identidad de un **[[Elemento]]**.
* **Electrones de Valencia**: Son los electrones de la capa externa, responsables de las interacciones y los **[[Enlaces químicos]]**.
* **[[Isótopos]]**: Variantes de un mismo elemento con diferente número de neutrones. Algunos son inestables (**radiactivos**) y su desintegración se usa en [[datación absoluta]].
...
Un **[[Mineral]]** es cualquier **sólido inorgánico natural** que posee una **estructura cristalina ordenada** y una **composición química bien definida**.

Para ser un mineral, un material terrestre debe cumplir con cinco requisitos:
1.  **[[Aparición Natural]]**: Formado por procesos geológicos (no sintético).
2.  **[[Sustancia Sólida]]**: Debe existir en estado sólido (ej. el hielo es mineral; el agua líquida no).
3.  **[[Estructura Cristalina Ordenada]]**: Los átomos están dispuestos en un patrón geométrico regular y repetitivo.
4.  **[[Composición Química Definida]]**: Expresada por una fórmula química (ej. $\text{CaCO}_3$).
5.  **[[Normalmente Inorgánico]]**: Se excluyen los compuestos orgánicos complejos (excepto por ciertas excepciones históricas).
